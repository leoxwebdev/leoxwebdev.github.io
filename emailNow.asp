...
initialize
			...
			''ConfNo = request.form("message")
			ConfNo="RS140427M02"
			
			strSQL = "SELECT * from guestrecord where ConfirmationNum='"&ConfNo&"'"
			''strSQL = "SELECT * from guestrecord where ConfirmationNum='RS140427M02'
	...
	''if SendEmail<>"Y" then
		...
		'End remote SMTP server configuration section==
			...
			ObjSendMail.CreateMHTMLBody  "http://bmxt.com/onlinebooking/mobile/confirmleox.php?ConfirmationNum="&ConfNo
			...
			ObjSendMail.From = fromsname & " <" & senderEmail & ">"
			''ObjSendMail.To = "leo@plantationbay.com"
			ObjSendMail.To = "rsvns@plantationbay.com"
			''ObjSendMail.HTMLBody = "http://www.bmxt.com/onlinebooking/mobile/RS140420M04.html"
			ObjSendMail.CreateMHTMLBody  "http://bmxt.com/onlinebooking/mobile/confirmleox.php?ConfirmationNum="&ConfNo
			''ObjSendMail.CreateMHTMLBody  "http://bmxt.com/onlinebooking/mobile/confleox1.php?data=" & bodytext
			''ObjSendMail.HTMLBody = bodytext
			''ObjSendMail.TextBody = bodytext
