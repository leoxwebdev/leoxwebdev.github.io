<?php
	$satisfactionguarantee = "<p class='iJustify'><strong>The Plantation Bay Room and Restaurant Satisfaction Guarantee.</strong>  We would like all our guests to feel they made the right choice in coming here. And most of our guests do, so we can afford to be liberal with those who don’t:</p>" .
		...
		"<li>in case you made any advance payment or deposit, even for peak or blackout periods,<br />the entire amount will be refunded to you in cash in Philippine peso equivalent;</li>" .
