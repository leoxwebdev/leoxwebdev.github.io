<?php
				/*<!-- end Water's Edge Room page --> */
						$WER = "<div class='IpatungaInlineBlock roomAndDetails'>" .
							"<img class='IpatungaDblock' title='Water\'s Edge Room' src='pbayImages/watersedge.jpg' />" .
							"<p class='iLeft'>Our most sought-after room, located right at the edge of our lagoon. It has a luxurious bathroom with separate tub and shower, and a spacious balcony. You can be in the water in 0-2 seconds. (This room is intended for couples only and not suitable for children below 18 years of age, due to close-by water hazards.)</p>" .
						"</div>" .
						...
						/*<!-- Lagoon Side Room -->*/
						$LSR = "<div class='IpatungaInlineBlock roomAndDetails'>" .
							"<img class='IpatungaDblock' title='Lagoon Side Room' src='pbayImages/lagoonside_nile.jpg' />" .
						...
						/*<!-- Lagoon View Room -->*/
						$LVR = "<div class='IpatungaInlineBlock roomAndDetails'>" .
							"<img class='IpatungaDblock' title='Lagoon View Room' src='pbayImages/lagoonview.jpg' />" .
						...
						/*<!-- Poolside Room -->*/
						$PS = "<div class='IpatungaInlineBlock roomAndDetails'>" .
							"<img class='IpatungaDblock' title='Poolside Room' src='pbayImages/poolsideroom.jpg' />" .
						...
						$SIR = "<div class='IpatungaInlineBlock roomAndDetails'>" .
							"<img class='IpatungaDblock' title='Spa Indulgence Room and Package' src='pbayImages/spaindulgenceroom.jpg' />" .
						...
						/*<!-- Family Room -->*/
						$FR = "<div class='IpatungaInlineBlock roomAndDetails'>" .
							"<img class='IpatungaDblock' title='Family Room' src='pbayImages/familyroom.jpg' />" .
						...
						$OneBS = "<div class='IpatungaInlineBlock roomAndDetails'>" .
							"<img class='IpatungaDblock' title='One Bedroom Suite' src='pbayImages/1bedroomsuite.jpg' />" .
						...
						$TwoBS = "<div class='IpatungaInlineBlock roomAndDetails'>" .
							"<img class='IpatungaDblock' title='Two Bedroom Suite' src='pbayImages/2bedroomsuite.jpg' />" .
						...
						/*<!-- Quantum Villa Room -->*/
						$QV = "<div class='IpatungaInlineBlock roomAndDetails'>" .
							"<img class='IpatungaDblock' title='Quantum Villa' src='pbayImages/quantumvilla.jpg' />" .
						...
						$RB = "<div class='IpatungaInlineBlock roomAndDetails'>" .
							"<img class='IpatungaDblock' title='Riverboat Suite' src='pbayImages/riverboatsuite.jpg' />" .
