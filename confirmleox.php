...
<title>Plantation Bay Resort and Spa: Reservation Confirmation</title>
		...
		<div id="Conf" style="margin:0 auto;max-width:100%;margin-top:8px;">
			<div style="margin: 0 auto;max-width:780px;border:10px solid teal;">
				...
				<div id="Confheader" style="margin:0 auto;max-width:780px;background:white;">	
					<img src="images/confHead1.jpg" style="display: block;margin: 0 auto; max-width:100%;" alt="Plantation Bay Resort and Spa" />
				...
				<p style="margin-left:10px; margin-right:10px;">Sincerely,
					<br>Plantation Bay Resort and Spa
					<br>Marigondon, Mactan Island
					<br>Cebu, Philippines 6015
					<br><a href="http://plantationbay.com/english/index.html" target="_blank">plantationbay.com</a>
				</p>
				
				<div class="spacer15px"></div><div class="spacer15px"></div>
				<!--
				<hr />
				...
				<div data-role="footer">
					...
					<div class="CopyRight">
						&copy;2014 <a href="http://plantationbay.com/english/index.html" target="_blank">Plantation Bay Resort and Spa</a>. All rights reserved.
