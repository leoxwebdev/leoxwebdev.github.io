...
<div data-role="page" id="confirmation">
		...
		<div class="headerwhole">
			...
			<div class="linguahi">
				<ul class="langOptions action-bar clearfix">
					...
					<li><a href="/english/" class="lang_link" data-ajax="false"><img src="images/flags/english.png" alt="" /><span class="langs"></span><span class="langtooltip">English</span></a></li>
					<li><a href="/japanese/" class="lang_link" data-ajax="false"><img src="images/flags/japanese.png" alt="" /><span class="langs"></span><span class="langtooltip">Japanese</span></a></li>
					<li><a href="/russian/" class="lang_link" data-ajax="false"><img src="images/flags/russian.png" alt="" /><span class="langs"></span><span class="langtooltip">Russian</span></a></li>
					<li><a href="/english/" class="lang_link" data-ajax="false"><img src="images/flags/korean.png" alt="" /><span class="langs"></span><span class="langtooltip">Korean</span></a></li>
					<li><a href="/english/" class="lang_link" data-ajax="false"><img src="images/flags/mandarin.png" alt="" /><span class="langs"></span><span class="langtooltip">Mandarin</span></a></li>
				</ul>
			</div>
			...
			<section class="top-menus">
				<nav class="main" role="navigation">
					...
					<a href="images.html" data-ajax="false" data-role="button">IMAGES</a>
	...
	<div data-role="content">
		...
		<input type="hidden" id="ConfirmationNum" value="<?php echo $ConfirmationNum; ?>">
		<input type="hidden" id="guestID" value="<?php echo $guestID; ?>">
		<input type="hidden" id="ArrivalDate" value="<?php echo $ArrivalDate; ?>">
		<input type="hidden" id="DepartureDate" value="<?php echo $DepartureDate; ?>">
		<input type="hidden" id="CntRoomTypesSelected" value="<?php echo $CntRoomTypesSelected; ?>">
		<input type="hidden" id="Adults" value="<?php echo $Adults; ?>">
		<input type="hidden" id="Children" value="<?php echo $Children; ?>">
		
		<input type="hidden" id="VEP" value="<?php echo $VEP; ?>">
		<input type="hidden" id="RRP" value="<?php echo $RRP; ?>">
		<input type="hidden" id="CCP" value="<?php echo $CCP; ?>">
		<input type="hidden" id="PAP" value="<?php echo $PAP; ?>">
		<input type="hidden" id="PSBF" value="<?php echo $PSBF; ?>">
		<input type="hidden" id="FABF" value="<?php echo $FABF; ?>">
		<input type="hidden" id="LVBF" value="<?php echo $LVBF; ?>">
		<input type="hidden" id="LSBF" value="<?php echo $LSBF; ?>">
		<input type="hidden" id="WEBF" value="<?php echo $WEBF; ?>">
		<input type="hidden" id="OBKBF" value="<?php echo $OBKBF; ?>">
		<input type="hidden" id="TKKBF" value="<?php echo $TKKBF; ?>">
		<input type="hidden" id="RBBF" value="<?php echo $RBBF; ?>">
		<input type="hidden" id="PHBF" value="<?php echo $PHBF; ?>">
		<input type="hidden" id="QVBF" value="<?php echo $QVBF; ?>">
		<input type="hidden" id="SPABF" value="<?php echo $SPABF; ?>">
		<input type="hidden" id="RoomConversion" value="<?php echo $RoomConversion; ?>">
		...
		<div style="max-width:200px;margin:0 auto; text-align:center;">
			...
			<!--<a id="emailConf" href="#" data-role="button" data-inline="true" data-mini="true"> SEND TO EMAIL </a> -->
		</div>
...
<script type="text/javascript" src="rlmjConf.js"></script>
<!-- Google Code for Bookings Conversion Page -->
<script type="text/javascript">
/* <![CDATA[ */
var google_conversion_id = 1017823919;
var google_conversion_language = "en";
var google_conversion_format = "2";
var google_conversion_color = "ffffff";
var google_conversion_label = "gx5XCPn7qVkQr4Wr5QM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/1017823919/?label=gx5XCPn7qVkQr4Wr5QM&amp;guid=ON&amp;script=0"/>
</div>
</noscript><!-- END - Google Code for Bookings Conversion Page -->
</body>
</html>